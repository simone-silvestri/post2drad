...
subroutine write_vtk_vector_2D_ASCII(input,namefile,cha,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
  ...
  if(myid==0) then
   ...
   write(1,'(A11,3I6)') 'DIMENSIONS ', im, 1, kmax
   write(1,231) im  
...
subroutine write_vtk_budbas_2D_ASCII(input,namefile,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
...
233          format('Z_COORDINATE ',I8,' float')
   ...
   enddo
   write(1,*)
   write(1,'(A11,I10)') 'POINT_DATA ', (im)*(kmax)
   write(1,*) header4  
   write(1,'(A20)') 'LOOKUP_TABLE default'
   do k=1,kmax
    do i=1,im
...
subroutine write_vtk_budtke_2D_ASCII(input,namefile,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
  ...
  character(len=19)            :: header22,header23
...
subroutine write_vtk_budget_2D_ASCII(input,namefile,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
  ...
  character(len=19)            :: header19,header20,header21,header22,header23
...
subroutine write_vtk_tensor_2D_ASCII(input,namefile,cha,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
...
subroutine write_vtk_one_2D_ASCII(input,namefile,cha,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
...
subroutine write_vtk_one_2D(input,namefile,myid,im) 
  use params
  use decomp_2d
  implicit none
  include 'common.txt'
